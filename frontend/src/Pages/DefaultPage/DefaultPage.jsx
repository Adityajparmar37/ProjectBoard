  ...
  return (
    <div className="pt-20 bg-gradient-to-b from-sky-300 h-screen flex flex-col md:flex-row items-center justify-center">
      <div className="flex flex-col items-center justify-center text-center md:text-left md:ml-10">
        ...
        <button
          type="button"
          className="w-28 h-14 text-white bg-blue-700 hover:bg-blue-800 hover:rounded-[5rem] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          Sign Up
        </button>
      </div>
